...
import { useViewDeliveriesQuery, useDeleteDeliveryMutation, useUpdateDeliveryMutation } from '../slices/deliverySlice';
  ...
  return (
    <div className="vh-100 d-flex justify-content-center align-items-center" ref={ComponentsRef}>
      <Container style={{ backgroundColor: "white", padding: "20px", borderRadius: "10px" }}>
        <h1 className="text-center text-black mb-4 mt-8">View Deliveries</h1>
