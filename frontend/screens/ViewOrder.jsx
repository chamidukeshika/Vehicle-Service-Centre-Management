  ...
  return (
    <div className="vh-100 d-flex justify-content-center align-items-center">
      <Container style={{ backgroundColor: "rgba(255, 255, 255, 0.7)", padding: "20px", borderRadius: "10px" }}>
        ...
        <Link to="../orders/add">
        <button type="button" className="btn btn-primary" style={{ marginLeft: '875px' }}> Add Order </button>
        </Link>
          ...
          <nav aria-label="Page navigation example">
            <ul className="pagination">
              ...
              <li className="page-item">
                <button className="page-link" onClick={handleNextPage} disabled={currentOrders.length < itemsPerPage}>Next</button>
              </li>
            </ul>
          </nav>
        </div>
        ...
        {currentOrders.length > 0 ? (
              ...
              {currentOrders.map(order => (
                <tr key={order._id}>
                  ...
                  <td>
                    ...
                    >
                      <Button onClick={() => updateHandler(order._id)} variant="primary" className="me-2">
                    ...
                    >
                      <Button onClick={() => handleDeleteClick(order._id)} variant="danger">
          ...
          <center><div style={{marginTop:"150px"}}><h2>No Orders to display.</h2></div></center>
        )}
